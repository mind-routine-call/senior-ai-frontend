    ...
    return (
      <main className="flex min-h-full flex-col bg-[#f6f8fb] px-5 py-6 font-sans text-gray-900">
        <header className="mb-5 flex items-start justify-between gap-3">
          <div>
            <p className="text-sm font-bold text-[#4d6fb6]">새 어르신 등록</p>
            <h1 className="mt-1 text-[25px] font-black leading-tight">등록이 완료되었습니다</h1>
        ...
        <section className="rounded-[28px] bg-white p-6 shadow-sm">
          ...
          <div className="text-center">
            ...
            <h2 className="mt-2 text-[28px] font-black text-gray-900">
              {createdElder.name}
            </h2>
          </div>

          <div className="mt-6 rounded-[22px] bg-[#2f66c9] px-4 py-5 text-white">
            <p className="text-sm font-bold text-white/75">초대코드</p>
            <div className="mt-2 flex items-center justify-between gap-3">
              <span className="break-all text-2xl font-black tracking-wide">
          ...
          <p className="mt-5 rounded-2xl bg-[#f7f9fc] px-4 py-4 text-sm font-bold leading-6 text-gray-600">
        ...
        <div className="mt-5 grid gap-3">
          <button
            type="button"
            onClick={goDashboard}
            className="rounded-[22px] bg-[#2f66c9] py-5 text-xl font-black text-white shadow-sm"
          >
            대시보드로 이동
          </button>
          <button
            ...
            className="rounded-[22px] bg-white py-5 text-xl font-black text-gray-900 shadow-sm"
          >
            마이페이지로 돌아가기
          </button>
        </div>
    ...
    <main className="flex min-h-full flex-col bg-[#f6f8fb] px-5 py-6 font-sans text-gray-900">
      <header className="mb-5 flex items-start justify-between gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-bold text-[#4d6fb6]">보호자 관리</p>
          <h1 className="mt-1 text-[25px] font-black leading-tight">새 어르신 등록</h1>
          <p className="mt-1 text-sm font-semibold text-gray-500">
      ...
      <button
        ...
        className="mt-5 flex items-center justify-center gap-2 rounded-[22px] bg-[#2f66c9] py-5 text-xl font-black text-white shadow-sm disabled:opacity-60"
      >
  ...
  return (
    <label className="flex flex-col gap-2">
      <span className="text-sm font-black text-gray-800">
        {label}
        {required && <span className="text-[#2f66c9]"> *</span>}
      </span>
      <input
        type={type}
        value={value}
